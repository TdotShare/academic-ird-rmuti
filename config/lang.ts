interface IObjectKeys {
    [key : string] : { 
        menu_main_home : string 
        menu_main_personnel : string
        ...
        ourwork_structure : string
        ourwork_myjob : string
        ourwork_department_work : string
        ourwork_list : string
...
export const langDisplay : IObjectKeys  = {
    "th" : { 
        menu_main_home : "หน้าหลัก สวพ." ,
        ...
        breadcrumb_namefull : "บริการวิชาการ",
    ...
    "en" : {
        ...
        menu_main_personnel : "Personnel IRD",
        ...
        breadcrumb_namefull : "Academic",
        breadcrumb_organization_name : "IRD.",
        breadcrumb_rmuti_name : "RMUTI",
        ourwork_structure : "Management structure",
        ourwork_myjob : "Our Work",
        ourwork_department_work : "Department Work",
